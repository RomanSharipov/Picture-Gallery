Реализовал на Unity приложение, состоящее из трех основных сцен:
...
При загрузке картинок - текстуры сохраняются в кеш (Что бы не загружать их еще раз)# Picture-Gallery
